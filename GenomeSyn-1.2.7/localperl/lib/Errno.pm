...
"x86_64-linux-thread-multi-2.6.11-1.1369_fc4" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.11-1.1369_fc4) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
